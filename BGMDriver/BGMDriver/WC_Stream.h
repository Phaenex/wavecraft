...
//
//  An input or output audio stream. Each stream belongs to a device (see WC_AbstractDevice), which
//  in turn belongs to a plug-in (see WC_PlugIn).
//
...
public:
                                WC_Stream(AudioObjectID inObjectID,
