...
WC_AbstractDevice::WC_AbstractDevice(AudioObjectID inObjectID, AudioObjectID inOwnerObjectID)
:
    WC_Object(inObjectID, kAudioDeviceClassID, kAudioObjectClassID, inOwnerObjectID)
{
}

WC_AbstractDevice::~WC_AbstractDevice()
{
}

#pragma mark Property Operations

bool    WC_AbstractDevice::HasProperty(AudioObjectID inObjectID,
                                        pid_t inClientPID,
...
bool    WC_AbstractDevice::IsPropertySettable(AudioObjectID inObjectID,
                                               pid_t inClientPID,
                                               const AudioObjectPropertyAddress& inAddress) const
{
    bool theAnswer = false;
...
UInt32    WC_AbstractDevice::GetPropertyDataSize(AudioObjectID inObjectID,
                                                  pid_t inClientPID,
...
void    WC_AbstractDevice::GetPropertyData(AudioObjectID inObjectID,
                                            pid_t inClientPID,
                                            const AudioObjectPropertyAddress& inAddress,
                                            UInt32 inQualifierDataSize,
                                            ...
                                            void* outData) const
{
    ...
    switch(inAddress.mSelector)
    {
        ...
        case kAudioDevicePropertyAvailableNominalSampleRates:
            ...
            // a required property that can't be handled by this class or its parent, WC_Object.
            //
            // See WC_Device for info about these properties.
            //
            // TODO: Write a test that checks all required properties for each subclass.
            BGMAssert(false,
                      "WC_AbstractDevice::GetPropertyData: Property %u not handled in subclass",
                      inAddress.mSelector);
        ...
        case kAudioDevicePropertyTransportType:
            ...
            ThrowIf(inDataSize < sizeof(UInt32),
                    ...
                    "WC_AbstractDevice::GetPropertyData: not enough space for the return value of "
