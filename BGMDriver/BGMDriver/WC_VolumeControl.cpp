...
WC_VolumeControl::WC_VolumeControl(AudioObjectID inObjectID,
                                     AudioObjectID inOwnerObjectID,
                                     AudioObjectPropertyScope inScope,
                                     AudioObjectPropertyElement inElement)
:
    WC_Control(inObjectID,
...
bool    WC_VolumeControl::HasProperty(AudioObjectID inObjectID,
                                       pid_t inClientPID,
                                       const AudioObjectPropertyAddress& inAddress) const
{
    ...
    switch(inAddress.mSelector)
    {
        ...
        default:
            theAnswer = WC_Control::HasProperty(inObjectID, inClientPID, inAddress);
            break;
    };
...
bool    WC_VolumeControl::IsPropertySettable(AudioObjectID inObjectID,
                                              pid_t inClientPID,
                                              const AudioObjectPropertyAddress& inAddress) const
{
    CheckObjectID(inObjectID);
    ...
    switch(inAddress.mSelector)
    {
        ...
        default:
            theAnswer = WC_Control::IsPropertySettable(inObjectID, inClientPID, inAddress);
            break;
    };
...
UInt32  WC_VolumeControl::GetPropertyDataSize(AudioObjectID inObjectID,
                                               pid_t inClientPID,
                                               ...
                                               const void* inQualifierData) const
{
    ...
    switch(inAddress.mSelector)
    {
        ...
        default:
            theAnswer = WC_Control::GetPropertyDataSize(inObjectID,
                                                         inClientPID,
                                                         inAddress,
                                                         inQualifierDataSize,
                                                         inQualifierData);
...
void    WC_VolumeControl::GetPropertyData(AudioObjectID inObjectID,
                                           pid_t inClientPID,
                                           const AudioObjectPropertyAddress& inAddress,
                                           UInt32 inQualifierDataSize,
    ...
    switch(inAddress.mSelector)
    {
        case kAudioLevelControlPropertyScalarValue:
            // This returns the value of the control in the normalized range of 0 to 1.
            {
                ThrowIf(inDataSize < sizeof(Float32),
                        ...
                        "WC_VolumeControl::GetPropertyData: not enough space for the return value "
        ...
        case kAudioLevelControlPropertyDecibelRange:
            ...
            ThrowIf(inDataSize < sizeof(AudioValueRange),
                    CAException(kAudioHardwareBadPropertySizeError),
                    "WC_VolumeControl::GetPropertyData: not enough space for the return value of "
        ...
        default:
            WC_Control::GetPropertyData(inObjectID,
                                         inClientPID,
                                         inAddress,
                                         inQualifierDataSize,
                                         inQualifierData,
...
void    WC_VolumeControl::SetPropertyData(AudioObjectID inObjectID,
                                           pid_t inClientPID,
                                           const AudioObjectPropertyAddress& inAddress,
                                           UInt32 inQualifierDataSize,
                                           const void* inQualifierData,
                                           ...
                                           const void* inData)
{
    ...
    switch(inAddress.mSelector)
    {
        case kAudioLevelControlPropertyScalarValue:
            {
                ThrowIf(inDataSize != sizeof(Float32),
                        CAException(kAudioHardwareBadPropertySizeError),
                        "WC_VolumeControl::SetPropertyData: wrong size for the data for "
        ...
        default:
            WC_Control::SetPropertyData(inObjectID,
                                         inClientPID,
                                         inAddress,
                                         inQualifierDataSize,
                                         inQualifierData,
...
void    WC_VolumeControl::SetVolumeScalar(Float32 inNewVolumeScalar)
{
...
void    WC_VolumeControl::SetVolumeDb(Float32 inNewVolumeDb)
{
...
void    WC_VolumeControl::SetWillApplyVolumeToAudio(bool inWillApplyVolumeToAudio)
{
...
bool    WC_VolumeControl::WillApplyVolumeToAudioRT() const
{
    return mWillApplyVolumeToAudio;
}

void    WC_VolumeControl::ApplyVolumeToAudioRT(Float32* ioBuffer, UInt32 inBufferFrameSize) const
{
    ThrowIf(!mWillApplyVolumeToAudio,
            CAException(kAudioHardwareIllegalOperationError),
            "WC_VolumeControl::ApplyVolumeToAudioRT: This control doesn't process audio data");
...
void    WC_VolumeControl::SetVolumeRaw(SInt32 inNewVolumeRaw)
{
    CAMutex::Locker theLocker(mMutex);
    ...
    if(mVolumeRaw != inNewVolumeRaw)
    {
        ...
        CADispatchQueue::GetGlobalSerialQueue().Dispatch(false, ^{
            ...
            WC_PlugIn::Host_PropertiesChanged(GetObjectID(), 2, theChangedProperties);
        });
    }
}
