...
// Self Include
#include "WCVolumeChangeListener.h"
...
WCVolumeChangeListener::WCVolumeChangeListener(BGMAudioDevice device,
...
WCVolumeChangeListener::~WCVolumeChangeListener()
{
