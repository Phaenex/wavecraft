...
// Self Include
#include "WCBackgroundMusicDevice.h"
...
WCBackgroundMusicDevice::WCBackgroundMusicDevice()
:
    ...
    mUISoundsBGMDevice(CFSTR(kBGMDeviceUID_UISounds))
{
    ...
    {
        LogError("WCBackgroundMusicDevice::WCBackgroundMusicDevice: Error getting BGMDevice ID");
...
void WCBackgroundMusicDevice::SetAsOSDefault()
{
    DebugMsg("WCBackgroundMusicDevice::SetAsOSDefault: Setting the system's default audio device "
             "to BGMDevice");
...
void WCBackgroundMusicDevice::UnsetAsOSDefault(AudioDeviceID inOutputDeviceID)
{
    CAHALAudioSystemObject audioSystem;
    ...
    {
        DebugMsg("WCBackgroundMusicDevice::UnsetAsOSDefault: Setting the system's default output "
    ...
    {
        DebugMsg("WCBackgroundMusicDevice::UnsetAsOSDefault: Setting the system's default system "
...
CFArrayRef WCBackgroundMusicDevice::GetAppVolumes() const
{
    CFTypeRef appVolumes = GetPropertyData_CFType(kBGMAppVolumesAddress);

    ThrowIfNULL(appVolumes,
                CAException(kAudioHardwareIllegalOperationError),
                "WCBackgroundMusicDevice::GetAppVolumes: !appVolumes");
    ThrowIf(CFGetTypeID(appVolumes) != CFArrayGetTypeID(),
            CAException(kAudioHardwareIllegalOperationError),
            "WCBackgroundMusicDevice::GetAppVolumes: Expected CFArray value");

    return static_cast<CFArrayRef>(appVolumes);
}

void WCBackgroundMusicDevice::SetAppVolume(SInt32 inVolume,
                                            ...
                                            CFStringRef __nullable inAppBundleID)
{
    BGMAssert((kAppRelativeVolumeMinRawValue <= inVolume) &&
              ...
              "WCBackgroundMusicDevice::SetAppVolume: Volume out of bounds");
...
void WCBackgroundMusicDevice::SetAppPanPosition(SInt32 inPanPosition,
                                                 pid_t inAppProcessID,
                                                 CFStringRef __nullable inAppBundleID)
{
    BGMAssert((kAppPanLeftRawValue <= inPanPosition) && (inPanPosition <= kAppPanRightRawValue),
              "WCBackgroundMusicDevice::SetAppPanPosition: Pan position out of bounds");
...
CFArrayRef WCBackgroundMusicDevice::GetAppEQ() const
{
    CFTypeRef appEQ = GetPropertyData_CFType(kBGMAppEQAddress);

    ThrowIfNULL(appEQ,
                CAException(kAudioHardwareIllegalOperationError),
                "WCBackgroundMusicDevice::GetAppEQ: !appEQ");
    ThrowIf(CFGetTypeID(appEQ) != CFArrayGetTypeID(),
            CAException(kAudioHardwareIllegalOperationError),
            "WCBackgroundMusicDevice::GetAppEQ: Expected CFArray value");

    return static_cast<CFArrayRef>(appEQ);
}

void WCBackgroundMusicDevice::SetAppEQBandGains(const std::array<Float32, kBGMAppEQNumBands>& inGainsDB,
                                                 pid_t inAppProcessID,
                                                 CFStringRef __nullable inAppBundleID)
{
...
void WCBackgroundMusicDevice::SendAppVolumeOrPanToBGMDevice(SInt32 inNewValue,
...
WCBackgroundMusicDevice::ResponsibleBundleIDsOf(CACFString inParentBundleID)
{
...
BGMDeviceAudibleState WCBackgroundMusicDevice::GetAudibleState() const
{
    CFTypeRef propertyDataRef = GetPropertyData_CFType(kBGMAudibleStateAddress);

    ThrowIfNULL(propertyDataRef,
                CAException(kAudioHardwareIllegalOperationError),
                "WCBackgroundMusicDevice::GetAudibleState: !propertyDataRef");

    ThrowIf(CFGetTypeID(propertyDataRef) != CFNumberGetTypeID(),
            CAException(kAudioHardwareIllegalOperationError),
            "WCBackgroundMusicDevice::GetAudibleState: Property was not a CFNumber");
    ...
    ThrowIf(!success,
            CAException(kAudioHardwareIllegalOperationError),
            "WCBackgroundMusicDevice::GetMusicPlayerProcessID: CFNumberGetValue failed");
...
pid_t WCBackgroundMusicDevice::GetMusicPlayerProcessID() const
{
    CFTypeRef propertyDataRef = GetPropertyData_CFType(kBGMMusicPlayerProcessIDAddress);

    ThrowIfNULL(propertyDataRef,
                CAException(kAudioHardwareIllegalOperationError),
                "WCBackgroundMusicDevice::GetMusicPlayerProcessID: !propertyDataRef");

    ThrowIf(CFGetTypeID(propertyDataRef) != CFNumberGetTypeID(),
            CAException(kAudioHardwareIllegalOperationError),
            "WCBackgroundMusicDevice::GetMusicPlayerProcessID: Property was not a CFNumber");
...
CFStringRef WCBackgroundMusicDevice::GetMusicPlayerBundleID() const
{
    CFStringRef bundleID = GetPropertyData_CFString(kBGMMusicPlayerBundleIDAddress);

    ThrowIfNULL(bundleID,
                CAException(kAudioHardwareIllegalOperationError),
                "WCBackgroundMusicDevice::GetMusicPlayerBundleID: !bundleID");
...
bool WCBackgroundMusicDevice::GetDebugLoggingEnabled() const
{
    CFTypeRef propertyDataRef = GetPropertyData_CFType(kBGMDebugLoggingEnabledAddress);

    ThrowIfNULL(propertyDataRef,
                CAException(kAudioHardwareIllegalOperationError),
                "WCBackgroundMusicDevice::GetDebugLoggingEnabled: !propertyDataRef");

    ThrowIf(CFGetTypeID(propertyDataRef) != CFBooleanGetTypeID(),
            CAException(kAudioHardwareIllegalOperationError),
            "WCBackgroundMusicDevice::GetDebugLoggingEnabled: Property was not a CFBoolean");
