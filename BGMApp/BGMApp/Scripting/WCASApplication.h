...
@interface WCASApplication : NSObject
...
// elements when set -- see WCAppVolumesController's getEQBandGainsForApp:/
...
@property (copy) NSArray<WCASOutputDevice*>* outputDevices;
