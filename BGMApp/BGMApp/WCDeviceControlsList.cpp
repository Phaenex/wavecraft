...
// Self Include
#include "WCDeviceControlsList.h"
...
WCDeviceControlsList::WCDeviceControlsList(AudioObjectID inBGMDevice,
    ...
    mAudioSystem(inAudioSystem)
{
    BGMAssert((mBGMDevice.IsBGMDevice() || mBGMDevice.GetObjectID() == kAudioObjectUnknown),
              "WCDeviceControlsList::WCDeviceControlsList: Given device is not BGMDevice");
...
WCDeviceControlsList::~WCDeviceControlsList()
{
    ...
    {
        BGMLogAndSwallowExceptions("WCDeviceControlsList::~WCDeviceControlsList", ([&] {
    ...
    {
        DebugMsg("WCDeviceControlsList::~WCDeviceControlsList: Waiting for device toggle");
...
#pragma clang diagnostic pop
        ...
        if(timedOut)
        {
            LogWarning("WCDeviceControlsList::~WCDeviceControlsList: Device toggle timed out");
        }
    }
...
void    WCDeviceControlsList::SetBGMDevice(AudioObjectID inBGMDeviceID)
{
    CAMutex::Locker locker(mMutex);
    ...
    BGMAssert(mBGMDevice.IsBGMDevice(),
              "WCDeviceControlsList::SetBGMDevice: Given device is not BGMDevice");
}

#pragma mark Update Controls List

bool    WCDeviceControlsList::MatchControlsListOf(AudioObjectID inDeviceID)
{
    CAMutex::Locker locker(mMutex);

    if(!mBGMDevice.IsBGMDevice())
    {
        LogWarning("WCDeviceControlsList::MatchControlsListOf: BGMDevice ID not set");
        return false;
    }
    ...
    ThrowIf(!enabledControlsRef || (CFGetTypeID(enabledControlsRef) != CFArrayGetTypeID()),
            ...
            "WCDeviceControlsList::MatchControlsListOf: Expected a CFArray for "
    ...
    BGMAssert(enabledControls.GetNumberItems() == 2,
              "WCDeviceControlsList::MatchControlsListOf: Expected 2 array elements for "
              "kAudioDeviceCustomPropertyEnabledOutputControls");
    ...
    ThrowIf(!didGetBool,
            CAException(kAudioHardwareIllegalOperationError),
            "WCDeviceControlsList::MatchControlsListOf: Expected volume element of "
    ...
    ThrowIf(!didGetBool,
            CAException(kAudioHardwareIllegalOperationError),
            "WCDeviceControlsList::MatchControlsListOf: Expected mute element of "
            "kAudioDeviceCustomPropertyEnabledOutputControls to be a CFBoolean");

    DebugMsg("WCDeviceControlsList::MatchControlsListOf: BGMDevice has volume %s, mute %s",
    ...
    if(!hasVolume)
    {
        ...
        {
            BGMLogAndSwallowExceptionsMsg("WCDeviceControlsList::MatchControlsListOf",
    ...
    {
        DebugMsg("WCDeviceControlsList::MatchControlsListOf: %s BGMDevice volume control.",
    ...
    {
        DebugMsg("WCDeviceControlsList::MatchControlsListOf: %s BGMDevice mute control.",
...
void    WCDeviceControlsList::PropagateControlListChange()
{
    CAMutex::Locker locker(mMutex);
    ...
    BGMLogAndSwallowExceptions("WCDeviceControlsList::PropagateControlListChange", ([&] {
        bgmDeviceIsDefault =
    ...
    if(bgmDeviceIsDefault)
    {
        ...
        {
            mDeviceToggleState = ToggleState::NotToggling;
            LogError("WCDeviceControlsList::PropagateControlListChange: Could not enable the Null "
                     "Device");
            throw;
        }
    }
...
void    WCDeviceControlsList::InitDeviceToggling()
{
    CAMutex::Locker locker(mMutex);
    ...
    BGMAssert(mBGMDevice.IsBGMDevice(),
              "WCDeviceControlsList::InitDeviceToggling: mBGMDevice device is not set to "
              "BGMDevice's ID");
...
#pragma clang diagnostic pop
    mListenerQueue = dispatch_queue_create("com.bearisdriving.BGM.WCDeviceControlsList", attr);
                ...
                case kAudioHardwarePropertyDevices:
                    {
                        ...
                        DebugMsg("WCDeviceControlsList::InitDeviceToggling: Got "
...
#pragma clang diagnostic pop
    ...
    BGMLogAndSwallowExceptions("WCDeviceControlsList::InitDeviceToggling", [&] {
...
void    WCDeviceControlsList::ToggleDefaultDevice()
{
    ...
    if(nullDeviceID == kAudioObjectUnknown)
    {
        ...
        // warning.
        LogWarning("WCDeviceControlsList::ToggleDefaultDevice: Null Device not found");
        return;
    }

    DebugMsg("WCDeviceControlsList::ToggleDefaultDevice: Setting Null Device as default. "
...
void    WCDeviceControlsList::SetNullDeviceEnabled(bool inEnabled)
{
    DebugMsg("WCDeviceControlsList::SetNullDeviceEnabled: %s the null device",
    ...
    {
        LogError("WCDeviceControlsList::SetNullDeviceEnabled: BGMDriver plug-in audio object not "
                 "found");
...
dispatch_block_t __nullable WCDeviceControlsList::CreateDeviceToggleBlock()
{
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wpartial-availability"
...
#pragma clang diagnostic pop
        ...
        {
            BGMLogAndSwallowExceptions("WCDeviceControlsList::CreateDeviceToggleBlock",
                                       ([&] {
                ToggleDefaultDevice();
            }));
        }
    ...
    if(!toggleBlock)
    {
        ...
        LogError("WCDeviceControlsList::CreateDeviceToggleBlock: !toggleBlock");
    }

    return toggleBlock;
}

dispatch_block_t __nullable WCDeviceControlsList::CreateDeviceToggleBackBlock()
{
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wpartial-availability"
...
#pragma clang diagnostic pop
        ...
        DebugMsg("WCDeviceControlsList::ToggleDefaultDevice: Setting BGMDevice as default");
        BGMLogAndSwallowExceptions("WCDeviceControlsList::CreateDeviceToggleBackBlock", ([&] {
...
#pragma clang diagnostic pop
    ...
    {
        // Pretty sure this should never happen, but the docs aren't completely clear.
        LogError("WCDeviceControlsList::CreateDeviceToggleBackBlock: !toggleBackBlock");
    }

    return toggleBackBlock;
}

dispatch_block_t __nullable WCDeviceControlsList::CreateDisableNullDeviceBlock()
{
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wpartial-availability"
...
#pragma clang diagnostic pop
        ...
        BGMLogAndSwallowExceptions("WCDeviceControlsList::CreateDisableNullDeviceBlock",
                                   ([&] {
            CAMutex::Unlocker unlocker(mMutex);
    ...
    {
        // Pretty sure this should never happen, but the docs aren't completely clear.
        LogError("WCDeviceControlsList::CreateDisableNullDeviceBlock: !disableNullDeviceBlock");
    }

    return disableNullDeviceBlock;
}

void    WCDeviceControlsList::DestroyBlock(dispatch_block_t __nullable & block)
{
    if(!block)
    {
        return;
