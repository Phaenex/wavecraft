...
@interface WCMainPanel : NSPanel

// mainContentView is a WCMainPanelContentView added as this panel's content once, at init.
...
@property (nonatomic, readonly) WCMainPanelContentView* mainContentView;
