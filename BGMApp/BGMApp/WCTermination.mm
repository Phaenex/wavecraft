...
std::terminate_handler WCTermination::sOriginalTerminateHandler = std::get_terminate();

CAPThread* const       WCTermination::sExitSignalsThread = new CAPThread(ExitSignalsProc, nullptr);
sigset_t               WCTermination::sExitSignals;

WCAudioDeviceManager* __nullable WCTermination::sAudioDevices = nullptr;
...
void WCTermination::TestCrash()
{
    ...
    //                ^{
    //                    WCTermination::TestCrash();
    //                });

    // throw CAException(kAudioHardwareBadDeviceError);
    // throw WC_InvalidClientRelativeVolumeException();
    // std::string().at(1);
...
// static
void WCTermination::SetUpTerminationCleanUp(WCAudioDeviceManager* inAudioDevices)
{
...
// static
void    WCTermination::StartExitSignalsThread()
{
...
// static
void    WCTermination::CleanUpAudioDevices()
{
...
// static
void    WCTermination::AddCurrentExceptionToCrashReport()
{
...
// static
void* __nullable WCTermination::ExitSignalsProc(void* __nullable ignored)
{
    #pragma unused (ignored)

    DebugMsg("WCTermination::ExitSignalsProc: Thread started.");
