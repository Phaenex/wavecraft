...
@implementation WCSystemSoundsVolume {
...
- (void) systemSoundsSliderChanged:(id)sender {
    ...
    DebugMsg("WCSystemSoundsVolume::systemSoundsSliderChanged: UI sounds volume: %f", sliderLevel);

    BGMLogAndSwallowExceptions("WCSystemSoundsVolume::systemSoundsSliderChanged", ([&] {
