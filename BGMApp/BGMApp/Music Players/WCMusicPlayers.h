...
//
//  Holds the music players (i.e. WCMusicPlayer objects) available in BGMApp. Also keeps track of
...
@interface WCMusicPlayers : NSObject
...
// defaultMusicPlayerID is the musicPlayerID (see WCMusicPlayer.h) of the music player that should be
// selected by default.
//
...
@property (readonly) NSArray<id<WCMusicPlayer>>* musicPlayers;

// The music player currently selected in the preferences menu. BGMDevice is informed when this property
// is changed.
@property id<WCMusicPlayer> selectedMusicPlayer;
