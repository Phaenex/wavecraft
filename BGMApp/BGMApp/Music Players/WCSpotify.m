...
//  just s/iTunes/Spotify/ on WCiTunes.m
//
...
- (instancetype) init {
    ...
    if ((self = [super initWithMusicPlayerID:[WCMusicPlayerBase makeID:@"EC2A907F-8515-4687-9570-1BF63176E6D8"]
                                        name:@"Spotify"
...
- (BOOL) pause {
    ...
    if (wasPlaying) {
        DebugMsg("WCSpotify::pause: Pausing Spotify");
        [self.spotify pause];
    }
...
- (BOOL) unpause {
    ...
    if (wasPaused) {
        DebugMsg("WCSpotify::unpause: Unpausing Spotify");
