...
@implementation WCDecibel {
    WCScriptingBridge* scriptingBridge;
}

- (instancetype) init {
    if ((self = [super initWithMusicPlayerID:[WCMusicPlayerBase makeID:@"A9790CD5-4886-47C7-9FFC-DD70743CF2BF"]
                                        name:@"Decibel"
...
- (BOOL) pause {
    ...
    if (wasPlaying) {
        DebugMsg("WCDecibel::pause: Pausing Decibel");
        [self.decibel pause];
    }
...
- (BOOL) unpause {
    ...
    if (wasPaused) {
        DebugMsg("WCDecibel::unpause: Unpausing Decibel");
        [self.decibel play];
    }
