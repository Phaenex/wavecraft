...
- (instancetype) init {
    ...
    // command line tool).
    NSUUID* musicPlayerID = [WCMusicPlayerBase makeID:@"B74D18F6-DFF7-4D88-B719-429CFF98CFFA"];
...
- (BOOL) pause {
    ...
    if (wasPlaying) {
        DebugMsg("WCSwinsian::pause: Pausing Swinsian");
        [self.swinsian pause];
    }
...
- (BOOL) unpause {
    ...
    if (wasPaused) {
        DebugMsg("WCSwinsian::unpause: Unpausing Swinsian");
        [self.swinsian play];
    }
