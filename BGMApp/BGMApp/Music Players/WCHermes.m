...
- (instancetype) init {
    ...
    if ((self = [super initWithMusicPlayerID:[WCMusicPlayerBase makeID:@"0CDC67B0-56D3-4D94-BC06-6E380D8F5E34"]
                                        name:@"Hermes"
...
- (BOOL) pause {
    ...
    if (wasPlaying) {
        DebugMsg("WCHermes::pause: Pausing Hermes");
        [self.hermes pause];
    }
...
- (BOOL) unpause {
    ...
    if (wasPaused) {
        DebugMsg("WCHermes::unpause: Unpausing Hermes");
        [self.hermes play];
    }
