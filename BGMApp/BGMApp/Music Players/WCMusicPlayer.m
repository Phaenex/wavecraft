...
@implementation WCMusicPlayerBase
...
- (instancetype) initWithMusicPlayerID:(NSUUID*)musicPlayerID
    ...
    if ((self = [super init])) {
        NSAssert(musicPlayerID, @"WCMusicPlayerBase::initWithMusicPlayerID: !musicPlayerID");
        
        NSAssert([self conformsToProtocol:@protocol(WCMusicPlayer)],
                 @"WCMusicPlayerBase::initWithMusicPlayerID: !conformsToProtocol");
...
+ (NSUUID*) makeID:(NSString*)musicPlayerIDString {
    ...
    NSAssert(musicPlayerID, @"WCMusicPlayerBase::makeID: !musicPlayerID");
    
    return (NSUUID*)musicPlayerID;
}

#pragma mark WCMusicPlayer default implementations
