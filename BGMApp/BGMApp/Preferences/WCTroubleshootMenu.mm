...
@implementation WCTroubleshootMenu {
    ...
    WCXPCListener* __nullable xpcListener;
}
...
- (void) setXPCListener:(WCXPCListener*)inXPCListener {
...
- (NSUInteger) resetAllAppVolumesAndPan {
    ...
    // "unity gain" raw value WCAVM_VolumeMute restores to and WCAVM_VolumeSlider snaps to. 0 is
...
- (void) openSysPrefsMicrophonePrivacy {
    ...
    if (!opened) {
        NSLog(@"WCTroubleshootMenu::openSysPrefsMicrophonePrivacy: "
