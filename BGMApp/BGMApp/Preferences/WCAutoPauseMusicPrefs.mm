...
@implementation WCAutoPauseMusicPrefs {
...
- (void) initPreferencesMenuSection {
    ...
    for (id<WCMusicPlayer> musicPlayer in musicPlayers.musicPlayers) {
...
- (void) handleMusicPlayerChange:(NSMenuItem*)sender {
    ...
    id<WCMusicPlayer> musicPlayer = sender.representedObject;
    NSAssert(musicPlayer, @"WCAutoPauseMusicPrefs::handleMusicPlayerChange: !musicPlayer");
