...
//  device.
//
//  See BGMDriver/BGMDriver/WC_Device.h.
//
...
public:
     ...
     */
                        WCBackgroundMusicDevice();
    virtual            ~WCBackgroundMusicDevice();
...
#pragma mark App EQ
    ...
    /*!
     @param inGainsDB Exactly kBGMAppEQNumBands gains in dB, one per band (see
                      WC_AppEQ::kBandCenterFreqs in WC_Biquad.h for band order/frequencies),
...
private:
    ...
    friend class WCBackgroundMusicDeviceTestAccess;
