...
public:
                        WCPlayThrough(BGMAudioDevice inInputDevice, BGMAudioDevice inOutputDevice);
                        ~WCPlayThrough();
                        // Disallow copying
                        WCPlayThrough(const WCPlayThrough&) = delete;
                        WCPlayThrough& operator=(const WCPlayThrough&) = delete;
...
private:
    ...
    friend class WCPlayThroughTestAccess;
...
private:
    ...
    WCPlayThroughRTLogger mRTLogger;
