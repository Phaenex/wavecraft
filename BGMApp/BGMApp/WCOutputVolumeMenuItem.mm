...
@implementation WCOutputVolumeMenuItem {
...
- (void) initSlider {
    ...
    WCOutputVolumeMenuItem* __weak weakSelf = self;
...
- (void) updateVolumeSlider {
    ...
    BGMLogAndSwallowExceptions("WCOutputVolumeMenuItem::updateVolumeSlider", ([&] {
...
- (void) addOutputDeviceDataSourceListener {
    ...
    BGMLogAndSwallowExceptions("WCOutputVolumeMenuItem::addOutputDeviceDataSourceListener", ([&] {
...
- (void) removeOutputDeviceDataSourceListener {
    BGMLogAndSwallowExceptions("WCOutputVolumeMenuItem::removeOutputDeviceDataSourceListener",
                               ([&] {
...
- (void) updateLabelAndToolTip {
    if (outputDevice.GetObjectID() == kAudioObjectUnknown) {
        DebugMsg("WCOutputVolumeMenuItem::updateLabelAndToolTip: Output device unknown. Using the "
                 "generic label.");
        ...
        DebugMsg("WCOutputVolumeMenuItem::updateLabelAndToolTip: Output device: %u",
                 outputDevice.GetObjectID());

        try {
            if (outputDevice.HasDataSourceControl(kScope, kMainChannel)) {
                DebugMsg("WCOutputVolumeMenuItem::updateLabelAndToolTip: Getting data source ID");
                ...
                DebugMsg("WCOutputVolumeMenuItem::updateLabelAndToolTip: "
                ...
                DebugMsg("WCOutputVolumeMenuItem::updateLabelAndToolTip: Getting device name");
    ...
    DebugMsg("WCOutputVolumeMenuItem::updateLabelAndToolTip: Label: '%s' Tooltip: '%s'",
...
- (IBAction) sliderChanged:(NSSlider*)sender {
    ...
    DebugMsg("WCOutputVolumeMenuItem::sliderChanged: New value: %f", newValue);
    ...
    try {
        ...
        NSLog(@"WCOutputVolumeMenuItem::sliderChanged: Failed to set volume (%d)", e.GetError());
    }
}
