...
@interface WCHotkeyRecorderButton ()
@property (nonatomic, weak) id<WCHotkeyRecorderButtonDelegate> delegate;
@end

@implementation WCHotkeyRecorderButton {
...
- (instancetype) initWithFrame:(NSRect)frameRect
                       ...
                       delegate:(id<WCHotkeyRecorderButtonDelegate>)delegate {
