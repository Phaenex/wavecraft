...
public:
                        ...
                        WCDeviceControlsList(AudioObjectID inBGMDevice,
                                              CAHALAudioSystemObject inAudioSystem
                                                      = CAHALAudioSystemObject());
                        ~WCDeviceControlsList();
                        // Disallow copying
                        WCDeviceControlsList(const WCDeviceControlsList&) = delete;
                        WCDeviceControlsList& operator=(const WCDeviceControlsList&) = delete;
...
private:
    ...
    /*!
     Enable or disable the Null Device. See PropagateControlListChange and WC_NullDevice in 
     BGMDriver.
...
private:
    ...
    WCDeviceControlsList::ToggleState mDeviceToggleState = ToggleState::NotToggling;
