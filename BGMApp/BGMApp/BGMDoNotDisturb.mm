...
@implementation BGMDoNotDisturb {
...
// BGMAppVolumesController::shouldBeIncludedInMenu: uses -- so Do Not Disturb never tries to mute a
...
// BGMTroubleshootMenu use for an app with no recorded volume yet.
