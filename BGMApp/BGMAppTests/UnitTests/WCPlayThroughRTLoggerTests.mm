...
// Unit Include
#import "WCPlayThroughRTLogger.h"
...
@interface WCPlayThroughRTLoggerTests : XCTestCase

@end

@implementation WCPlayThroughRTLoggerTests
{
    WCPlayThroughRTLogger* logger;
}

- (void) setUp {
    [super setUp];
    logger = new WCPlayThroughRTLogger;
}
